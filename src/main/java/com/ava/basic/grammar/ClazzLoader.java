...
public class ClazzLoader {
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class.forName("com.ava.basic.grammar.AnnotationLearn");

        System.out.println("===============");

        Class<?> aClass = Thread.currentThread().getContextClassLoader()
                .loadClass("com.ava.basic.grammar.AnnotationLearn");
        try {
        ...
        try {
            ...
            Class<?> c1 = loader.loadClass("com.ava.basic.grammar.AnnotationLearn");
            ...
            loader = new MyClassLoader(
                    "/Users/lancer/IdeaProjects/God/kubernetes/test.jar");
            Class<?> c2 = loader.findClass("com.ava.basic.grammar.AnnotationLearn");
