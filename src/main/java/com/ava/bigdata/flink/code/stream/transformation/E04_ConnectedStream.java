package com.ava.bigdata.flink.code.stream.transformation;
...
public class E04_ConnectedStream {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> s1 = env.socketTextStream(CommonConstants.NC_HOST, 9998);

        SingleOutputStreamOperator<Integer> s2 = env.socketTextStream(CommonConstants.NC_HOST, 9999)
