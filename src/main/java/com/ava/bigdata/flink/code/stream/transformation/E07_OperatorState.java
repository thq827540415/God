...
public class E07_OperatorState {
    public static void main(String[] args) throws Exception {
        ...
        DataStreamSource<String> source1 = env.socketTextStream(CommonConstants.NC_HOST, 9998);
        DataStreamSource<String> source2 = env.socketTextStream(CommonConstants.NC_HOST, 9999);
