package com.lancer.bigdata.kafka.code;
...
public class E01_KafkaConsumer {
    public static void main(String[] args) throws IOException {
        Properties p = new Properties();
        p.load(E01_KafkaConsumer.class.getClassLoader().getResourceAsStream("consumer.properties"));
