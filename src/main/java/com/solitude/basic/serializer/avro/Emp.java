...
public class Emp extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static com.solitude.basic.serializer.avro.Emp.Builder newBuilder() {
    return new com.solitude.basic.serializer.avro.Emp.Builder();
  }
  
  /** Creates a new Emp RecordBuilder by copying an existing Builder */
  public static com.solitude.basic.serializer.avro.Emp.Builder newBuilder(com.solitude.basic.serializer.avro.Emp.Builder other) {
    return new com.solitude.basic.serializer.avro.Emp.Builder(other);
  }
  
  /** Creates a new Emp RecordBuilder by copying an existing Emp instance */
  public static com.solitude.basic.serializer.avro.Emp.Builder newBuilder(com.solitude.basic.serializer.avro.Emp other) {
    return new com.solitude.basic.serializer.avro.Emp.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Emp>
    ...
    private Builder() {
      super(com.solitude.basic.serializer.avro.Emp.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.solitude.basic.serializer.avro.Emp.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing Emp instance */
    private Builder(com.solitude.basic.serializer.avro.Emp other) {
            super(com.solitude.basic.serializer.avro.Emp.SCHEMA$);
    ...
    /** Sets the value of the 'name' field */
    public com.solitude.basic.serializer.avro.Emp.Builder setName(CharSequence value) {
    ...
    public com.solitude.basic.serializer.avro.Emp.Builder clearName() {
      name = null;
    ...
    /** Sets the value of the 'id' field */
    public com.solitude.basic.serializer.avro.Emp.Builder setId(int value) {
    ...
    public com.solitude.basic.serializer.avro.Emp.Builder clearId() {
    ...
    /** Sets the value of the 'salary' field */
    public com.solitude.basic.serializer.avro.Emp.Builder setSalary(int value) {
    ...
    public com.solitude.basic.serializer.avro.Emp.Builder clearSalary() {
    ...
    /** Sets the value of the 'age' field */
    public com.solitude.basic.serializer.avro.Emp.Builder setAge(int value) {
    ...
    public com.solitude.basic.serializer.avro.Emp.Builder clearAge() {
    ...
    /** Sets the value of the 'address' field */
    public com.solitude.basic.serializer.avro.Emp.Builder setAddress(CharSequence value) {
    ...
    public com.solitude.basic.serializer.avro.Emp.Builder clearAddress() {
      address = null;
